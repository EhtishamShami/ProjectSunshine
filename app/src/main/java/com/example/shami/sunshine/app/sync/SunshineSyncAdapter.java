package com.example.shami.sunshine.app.sync;
...
import com.example.shami.sunshine.app.MainActivity;
import com.example.shami.sunshine.app.R;
import com.example.shami.sunshine.app.Utility;
import com.example.shami.sunshine.app.data.WeatherContract;
import com.example.shami.sunshine.app.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED = "com.example.shami.sunshine.app.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String api="ab89d6fd0de7c23f7496b1ad72fabf2d";
            ...
            Uri builtUri = uriBuilder.appendQueryParameter(FORMAT_PARAM, format)
                    ...
                    .appendQueryParameter(API_Id,api)
                    .build();
